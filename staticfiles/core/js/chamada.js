...
function atualizarTabela() {
  const quantidadeAulas = parseInt(
    document.getElementById("quantidadeAulas").value
  );
  ...
  const alunos = [
    "João Santana Silva Moderato",
    "Maria",
    "Giovanni de Pita Cicero",
    "João Santana Silva Merato",
    "Maria",
    "Giovanni de Pita Cicero",
    "João Santana Silva Moderato",
    "Maria",
    "Giovanni de Pita Cicero",
  ]; // Substitua pelos nomes dos alunos reais
...
document
  .getElementById("quantidadeAulas")
